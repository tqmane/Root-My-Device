...
| --- | --- | --- | --- |
| Nothing Phone (3a) | `MODEL=A059`、`DEVICE=Asteroids`、build `B4.1-260618-1048` または `B4.1-260810-1153`（Android 16 / SDK 36）、または `C5.0-260915-2123`（Android 17 / SDK 37） | `6.1.157-android14-11-g82d681c9b06b-ab14634535`、`android14-6.1`、`core61`、arm64、4096-byte page | `260618`: Maintainer実機確認済み。`260810`: 対応。`260915`: 接続端末のidentityをallowlistへ追加済み、root flowは未確認。 |
